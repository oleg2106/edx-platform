...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.allowed_courses'
        db.add_column('auth_userprofile', 'allowed_courses',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.allowed_courses'
        db.delete_column('auth_userprofile', 'allowed_courses')
