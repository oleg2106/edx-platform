(function(requirejs, define) {
    ...
    requirejs.config({
        paths: {
            ...
            'mathjax': '//cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&locale=ru&delayStartupUntil=configured', // jshint ignore:line
