...
(function(requirejs) {
    ...
    requirejs.config({
        ...
        paths: {
            ...
            mathjax: '//cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_SVG&locale=ru&delayStartupUntil=configured',  // eslint-disable-line max-len
