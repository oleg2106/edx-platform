...
if settings.COURSEWARE_ENABLED:
    urlpatterns += (
        url(r'^courses/(?P<course_id>[^/]+/[^/]+/[^/]+)/api$',
            'courseware.views.course_api', name="couser_api"),
        ...
        url(r'^courses_list/?$', 'branding.views.courses_list', name="courses_list"),
        ...
        url(r'^courses/(?P<course_id>[^/]+/[^/]+/[^/]+)/cert$',
            'courseware.views.course_cert', name="cert"),
